...
func demonstrateNumberSchema() {
	...
	positiveNumber := schema.NewNumber().
		Positive().
...
func demonstrateIntegerSchema() {
	...
	basicInteger := schema.NewInteger().
...
func demonstrateBooleanSchema() {
	...
	flexibleBool := schema.NewBoolean().
	...
	caseInsensitive := schema.NewBoolean().
		CaseInsensitive().
	...
	flagSchema := schema.NewBoolean().
		Flag(). // Defaults to false
		Build()

	enabledSchema := schema.NewBoolean().
		Enabled(). // Defaults to false, description "Whether this feature is enabled"
		Build()

	switchSchema := schema.NewBoolean().
...
func ExampleErrorHandling() {
	...
	intSchema := schema.NewInteger().Build()
	...
	boolSchema := schema.NewBoolean().AllowStringConversion().Build()
...
func ExampleComplexValidation() {
	...
	userIdSchema := schema.NewInteger().
		ID().
		Name("user_id").
	...
	featureFlagSchema := schema.NewBoolean().
		Switch().
