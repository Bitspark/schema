...
func TestSchemaGeneratorCreateNullSchema(t *testing.T) {
	...
	if schema.Type() != schema2.TypeObject {
...
func TestSchemaGeneratorCreateAnySchema(t *testing.T) {
	...
	objectSchema := schema.(*schema2.ObjectSchema)
