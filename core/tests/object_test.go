...
func TestObjectSchemaProperties(t *testing.T) {
	stringSchema := core.NewString().Build()
	numberSchema := core.NewNumber().Build()

	schema := core.NewObject().
...
func TestObjectSchemaConstraints(t *testing.T) {
	...
	builder := builders.NewObjectBuilder()
...
func TestObjectSchemaNestedObjects(t *testing.T) {
	...
	addressSchema := core.NewObject().
		Property("street", core.NewString().Build()).
		Property("city", core.NewString().Build()).
...
func TestObjectSchemaJSONSchema(t *testing.T) {
	stringSchema := core.NewString().Build()
	numberSchema := core.NewNumber().Min(0).Build()
...
func TestObjectSchemaExampleGeneration(t *testing.T) {
	...
	schemaWithExample := core.NewObject().
		Property("name", stringSchema).
		Property("age", numberSchema).
...
func TestObjectSchemaBuilder(t *testing.T) {
	...
	schema := core.NewObject().
		...
		Property("name", core.NewString().Build()).
		Property("age", core.NewNumber().Build()).
		Required("name").
		AdditionalProperties(false).
...
func TestObjectBuilderAdditionalMethods(t *testing.T) {
	...
	schema := builder.
		RequiredProperty("name", core.NewString().Build()).
		OptionalProperty("email", core.NewString().Email().Build()).
		MinProperties(1).
		MaxProperties(10).
		Strict().
		Build()
...
func TestObjectBuilderHelperMethods(t *testing.T) {
	...
	apiSchema := builders.NewObjectBuilder().
		APIResponseExample().
		Build()
