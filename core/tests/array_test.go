...
func TestArraySchema(t *testing.T) {
	...
	t.Run("Min/Max items constraints", func(t *testing.T) {
		schema := core.NewArray().Range(2, 4).Build()
	...
	t.Run("Item schema validation", func(t *testing.T) {
		// Array of strings
		stringSchema := core.NewString().MinLength(2).Build()
		arraySchema := core.NewArray().Items(stringSchema).Build()
	...
	t.Run("Unique items constraint", func(t *testing.T) {
		schema := core.NewArray().UniqueItems().Build()
	...
	t.Run("Contains schema validation", func(t *testing.T) {
		...
		containsSchema := core.NewString().Pattern("^test").Build()
		arraySchema := core.NewArray().Contains(containsSchema).Build()
	...
	t.Run("Complex nested validation", func(t *testing.T) {
		...
		itemSchema := core.NewString().MinLength(3).Build()
	...
	t.Run("JSON Schema generation", func(t *testing.T) {
		itemSchema := core.NewString().Build()
...
func TestArrayBuilder(t *testing.T) {
	...
	t.Run("Type-specific helpers", func(t *testing.T) {
		...
		stringArraySchema := core.NewArray().StringArray().Build()
		...
		numberArraySchema := core.NewArray().NumberArray().Build()
		...
		intArraySchema := core.NewArray().IntegerArray().Build()
		...
		boolArraySchema := core.NewArray().BooleanArray().Build()
...
func TestArraySchemaEdgeCases(t *testing.T) {
	t.Run("Empty array validation", func(t *testing.T) {
		...
		minSchema := core.NewArray().MinItems(1).Build()
