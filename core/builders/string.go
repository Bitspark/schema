...
// It implements api.StringSchemaBuilder interface and returns api.StringSchema.
...
// NewString creates a new StringBuilder for creating string schemas.
...
// Build returns the constructed StringSchema as an api.StringSchema.
func (b *StringBuilder) Build() api.StringSchema {
	return schemas.NewStringSchema(b.config)
}

// Description sets the description metadata.
func (b *StringBuilder) Description(desc string) api.StringSchemaBuilder {
	clone := b.clone()
...
func (b *StringBuilder) Name(name string) api.StringSchemaBuilder {
	clone := b.clone()
...
func (b *StringBuilder) Tag(tag string) api.StringSchemaBuilder {
	clone := b.clone()
...
func (b *StringBuilder) MinLength(min int) api.StringSchemaBuilder {
	clone := b.clone()
	minVal := min
...
func (b *StringBuilder) MaxLength(max int) api.StringSchemaBuilder {
	clone := b.clone()
	maxVal := max
...
func (b *StringBuilder) Pattern(pattern string) api.StringSchemaBuilder {
	clone := b.clone()
	if pattern != "" {
...
func (b *StringBuilder) Format(format string) api.StringSchemaBuilder {
	clone := b.clone()
...
func (b *StringBuilder) Enum(values ...string) api.StringSchemaBuilder {
	clone := b.clone()
...
func (b *StringBuilder) Default(value string) api.StringSchemaBuilder {
	clone := b.clone()
...
func (b *StringBuilder) Example(example string) api.StringSchemaBuilder {
	clone := b.clone()
...
func (b *StringBuilder) Email() api.StringSchemaBuilder {
...
func (b *StringBuilder) UUID() api.StringSchemaBuilder {
...
func (b *StringBuilder) URL() api.StringSchemaBuilder {
	return b.Format("url").
